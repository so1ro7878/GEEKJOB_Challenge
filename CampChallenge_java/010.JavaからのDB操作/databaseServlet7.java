 ...
 * @author soich
 */
public class databaseServlet7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            //updateにてprofilesIDが1のレコードに対し、nameを松岡修造・ageを48・birthdayを1967-11-06に上書きします
            ...
            int i = db_st.executeUpdate();            
                    out.println(i + "件の処理の上書きに成功しました<br>");
