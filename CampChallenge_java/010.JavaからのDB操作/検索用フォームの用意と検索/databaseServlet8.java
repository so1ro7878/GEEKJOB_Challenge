 ...
 * @author soich
 */
public class databaseServlet8 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            db_st = db_con.prepareStatement("select * from profiles where name like '%" + n + "%'");
            ...
            while(db_data.next()){
                ...
                out.println("<font color = red size = 1>【</font>" + n + "<font color = red size = 1>】が存在していない場合はプロフィールは非表示されません…。</font>");
            db_data.close();
            db_st.close();
            db_con.close();
